...
驱动下载：![[Pasted image 20221031154927.png]]
## 2、准备数据
数据生成方式：Java自动随机生成
...
### 最终生成数据结果如下图:
#### (1)student.sql
![[Pasted image 20221031154620.png]]
#### (2)course.sql
![[Pasted image 20221031154645.png]]
#### (3)sc.sql
![[Pasted image 20221031154709.png]]
...
![[Pasted image 20221031154822.png]]

Course插入耗时（一万条记录）：1.4s
![[Pasted image 20221031154854.png]]
